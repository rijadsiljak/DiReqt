...
namespace DiReqt
{
    public partial class AdminPOS : Form
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text.Equals("OdKon"))
            {
                proba = "Kontroling";
            }
            else if (comboBox1.Text.Equals("OdDir"))
            {
                proba = "Uprava";
            }

            string querymt = "SELECT [ime] + ' ' + [prezime] as imeprezime FROM posodo where [uloga]=@pr";
            ...
            sifre.Parameters.AddWithValue("@pr", proba);
        ...
        private void AdminPOS_Load(object sender, EventArgs e)
        {
            ...
            string querymt = "SELECT  [odjel] FROM Odjeli where odjel='OdKon' or odjel='OdDir' ";
